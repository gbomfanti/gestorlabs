/**
 * Modal de Cadastro de Entradas
 * 
 * Este componente é responsável por renderizar o modal de cadastro de novas entradas financeiras,
 * permitindo o usuário registrar tanto entradas pontuais quanto recorrentes.
 */
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Ocorreu um erro ao criar a entrada. Tente novamente.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Registre uma nova entrada no sistema.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="one_time">Entrada Única</Label>
                </div>
                <div className="flex items-center space-x-2">
